...
export function Lights() {
  return (
    <>
      ...
      <spotLight color="#1C2541" position={[15, 10, -2]} intensity={2} />
      <spotLight color="#1C2541" position={[15, 10, 5]} intensity={1} />
      <spotLight color="#38393a" position={[5, -10, 5]} intensity={0.8} />
    </>
  );
}
